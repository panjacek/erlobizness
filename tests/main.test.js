		...
		dom = new JSDOM(
            ...
            <html>
                <body>
                    ...
                    <button id="buy-auction-btn"></button>
                    <button id="buy-try-btn"></button>
                    <div id="buy-mortgage-section"></div>
                    <div id="buy-mortgage-list"></div>
                    <div id="payment-modal"></div>
                    <p id="payment-modal-text"></p>
                    <div id="payment-mortgage-list"></div>
                    <button id="payment-resolve-btn"></button>
